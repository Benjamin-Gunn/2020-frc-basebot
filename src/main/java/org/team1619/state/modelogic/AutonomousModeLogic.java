...
public class AutonomousModeLogic extends AbstractModeLogic {
	...
	public void initialize() {
		...
		autoOrigin = (fSharedInputValues.getString("ips_auto_origin").toLowerCase().replaceAll("\\s", ""));
		autoDestination = (fSharedInputValues.getString("ips_auto_destination").toLowerCase().replaceAll("\\s", ""));
		autoAction = (fSharedInputValues.getString("ips_auto_action").toLowerCase().replaceAll("\\s", ""));
